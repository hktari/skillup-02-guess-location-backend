import { DatabaseConnection, GuessLocationRepository, LocationRepository } from "../../common/constants";
...
export const locationProviders = [
    ...
    },
    {
        ...
        useFactory: (dataSource: DataSource) => dataSource.getRepository(GuessLocationEntity),
        inject: [DatabaseConnection],
    },
]
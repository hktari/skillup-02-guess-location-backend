...
describe('AuthController', () => {
  ...
  it('signup returns AuthService result', async () => {
    ...
    const signupResult: UserEntity = { id: '0', email: 'test@example.com', firstName: 'john', lastName: 'scott', password: 'secret', imageUrl: 'https://...', locations: [] }
  ...
  describe('login', () => {
    it('should return AuthService login result', async () => {
      ...
      const loginDto: LoginDto = { email: 'test@example.com', password: 'secret' }
